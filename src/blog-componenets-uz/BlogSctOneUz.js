        ...
        <div className="row">
          <div className="first-div gx-5 col-lg-5 col-md-4 col-sm-12">
            <div class="card-overlay">
              <Link to="/aloneuz">
                Ingliz tilini yolg’iz qanday o’rganish mumkin?
              </Link>{" "}
              <p>07 Dec 2021</p>
            </div>
          </div>
          <div className="second-div gx-5 col-lg-3 col-md-4 col-sm-12">
            <div class="card-overlay">
              <Link to="/orfografuz">
                Ingliz tilidagi orfografik xatolarni qanday tekshirishni
                bilasizmi?
              </Link>{" "}
              <p>07 Dec 2021</p>
            </div>
          ...
          <div className="third-div gx-5 col-lg-3 col-md-4 col-sm-12">
            <div class="card-overlay">
              <Link to="/jokeuz">Ingliz tilida qanday yumor qilish mumkin?</Link>
              <p>07 Dec 2021</p>
            </div>
          </div>
        </div>
