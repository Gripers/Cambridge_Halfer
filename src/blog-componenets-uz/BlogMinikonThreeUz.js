        ...
        <div className="row">
          <div className="first-div gx-5 col-lg-3 col-md-4 col-sm-12">
            <div class="card-overlay">
              <Link to="/learnuz">Ingliz tilini o'rganish qiyin(mi?)</Link>{" "}
              <p>25 Nov 2021</p>
            </div>
          </div>
          <div className="second-div gx-5 col-lg-3 col-md-4 col-sm-12">
            <div class="card-overlay">
              <Link to="/traininguz">
                Reading imtihoniga to‘g‘ri tayyorlanish
              </Link>{" "}
              <p>25 Nov 2021</p>
            </div>
          </div>
          <div className="third-div gx-5 col-lg-5 col-md-4 col-sm-12">
            <div class="card-overlay">
              <Link to="/sertificatyuz">
                IELTS dan +7 olish uchun kun tartibi
              </Link>
              <p>25 Nov 2021</p>
            </div>
          </div>
...
`;
export default BlogMinikonThreeUz;
