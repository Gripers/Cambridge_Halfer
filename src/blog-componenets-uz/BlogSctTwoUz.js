      ...
      <div className="container">
        <div className="row">
          ...
          <div className="second-div gx-5 col-lg-5 col-md-4 col-sm-12">
            <div class="card-overlay">
              <Link to="/effectuz">
                Ingliz tilini o’rganishning 14 ta samarali usuli
              </Link>{" "}
              <p>07 Dec 2021</p>
            </div>
          </div>
          <div className="third-div gx-5 col-lg-3 col-md-4 col-sm-12">
            <div class="card-overlay">
              <Link to="/offlineuz">Online va offline ta’lim haqida</Link>
              <p>07 Dec 2021</p>
            </div>
          </div>
        </div>
